...
function App() {
  ...
  function analyseReviewPosition() {
    ...
    document.querySelector('#position-desk')?.scrollIntoView({ behavior: 'smooth', block: 'start' })
  }
  ...
  return <main className={`app ${theme === 'dark' ? 'dark' : ''}`}>
    <nav><a className="brand" href="#top"><span>♞</span> first<span>rank</span></a><div className="nav-links"><a href="#repertoire-rail">Openings</a><a href="#study">Study</a><a href="#puzzle-zone">Puzzles</a><a href="#game-lab">Game lab</a><a href="#player-desk">Player Intel</a><button className="theme-toggle" onClick={toggleTheme} aria-label="Toggle color theme">{theme === 'light' ? '◐ Dark' : '◑ Light'}</button><button className="streak">⚡ Learn daily</button></div></nav>

...
const openings = [
  ...
  { id: 'dragon', tag: 'BLACK REPERTOIRE', category: 'Open Game', name: 'Sicilian Dragon', eco: 'B70', tempo: 'Sharp', moves: ['e4','c5','Nf3','d6','d4','cxd4','Nxd4','Nf6','Nc3','g6'], promise: 'Fianchetto the dark bishop and make the long diagonal a tactical weapon.', plans: ['Castle quickly', 'Pressure d4 with pieces', 'Counter on the queenside when White storms the king'], trap: 'Do not attack on the queenside while your king is still exposed in the centre.', defense: 'White should complete development before opening the h-file or sacrificing near the king.' },
  { id: 'sveshnikov', tag: 'BLACK REPERTOIRE', category: 'Open Game', name: 'Sveshnikov Sicilian', eco: 'B33', tempo: 'Dynamic', moves: ['e4','c5','Nf3','Nc6','d4','cxd4','Nxd4','Nf6','Nc3','e5'], promise: 'Accept a structural concession to seize central space and active piece play.', plans: ['Use the d5 square carefully', 'Challenge the knight with ...b5', 'Develop with tempo before defending weaknesses'], trap: 'The weakened d5 square matters only if White can occupy it without tactical cost.', defense: 'White should pressure d5 and the backward pawn while keeping enough pieces to exploit the holes.' },
  { id: 'alapin', tag: 'WHITE REPERTOIRE', category: 'Open Game', name: 'Alapin Sicilian', eco: 'B22', tempo: 'Practical', moves: ['e4','c5','c3','d5','exd5','Qxd5','d4'], promise: 'Build a broad centre against the Sicilian without accepting its sharpest branches.', plans: ['Support d4 with development', 'Gain tempi on the queen', 'Use the centre before Black completes the setup'], trap: 'c3 is useful only when it prepares a real central claim.', defense: 'Black should pressure the new pawn centre and avoid chasing White’s pieces without development.' },
  { id: 'closed-sicilian', tag: 'WHITE REPERTOIRE', category: 'Open Game', name: 'Closed Sicilian', eco: 'B23', tempo: 'Strategic', moves: ['e4','c5','Nc3','Nc6','g3'], promise: 'Delay the central clash and build a flexible kingside setup against the Sicilian.', plans: ['Fianchetto the king bishop', 'Prepare f4 only with king safety', 'Choose the central break after development'], trap: 'A closed setup still needs a concrete break; do not merely shuffle behind the pawns.', defense: 'Black should gain queenside space and challenge the centre before White’s kingside pieces coordinate.' },
  { id: 'scotch-gambit', tag: 'WHITE REPERTOIRE', category: 'Open Game', name: 'Scotch Gambit', eco: 'C44', tempo: 'Initiative', moves: ['e4','e5','Nf3','Nc6','d4','exd4','Bc4'], promise: 'Trade a pawn’s immediate recovery for rapid development and open attacking lines.', plans: ['Castle before material hunting', 'Use the bishop’s pressure on f7', 'Develop with tempo'], trap: 'The gambit is about piece activity, not a pawn you must recover at any cost.', defense: 'Black should develop calmly and return material if that solves the king-safety problem.' },
  { id: 'two-knights', tag: 'WHITE REPERTOIRE', category: 'Open Game', name: 'Two Knights Defence', eco: 'C57', tempo: 'Forcing', moves: ['e4','e5','Nf3','Nc6','Bc4','Nf6','Ng5','d5','exd5','Nxd5'], promise: 'Test Black’s development immediately with a forcing central and kingside sequence.', plans: ['Calculate before attacking f7', 'Use development as compensation', 'Know when to return material for initiative'], trap: 'The knight jump to g5 is concrete, not an automatic attack in every Italian position.', defense: 'Black must meet the threat in the centre and avoid passive moves that leave f7 under pressure.' },
  { id: 'kings-indian-attack', tag: 'WHITE REPERTOIRE', category: 'Flank', name: "King's Indian Attack", eco: 'A07', tempo: 'Systematic', moves: ['Nf3','d5','g3','Nf6','Bg2','e6','O-O','Be7'], promise: 'Use a repeatable fianchetto setup, then decide where a prepared central or kingside break belongs.', plans: ['Complete development before advancing', 'Prepare d3 and e4 when possible', 'Keep the king bishop aimed at the centre'], trap: 'A system only works when it answers the opponent’s centre; do not ignore direct pawn breaks.', defense: 'Black should use central space and timely ...c5 or ...e5 before White builds a free attacking setup.' },
  { id: 'stonewall', tag: 'BLACK REPERTOIRE', category: 'Queen pawn', name: 'Dutch Stonewall', eco: 'A90', tempo: 'Committed', moves: ['d4','f5','Nf3','Nf6','g3','e6','Bg2','d5'], promise: 'Build a dark-square fortress and create a clear kingside plan at the cost of long-term flexibility.', plans: ['Control e4', 'Use the e5 outpost', 'Develop the dark bishop before locking it in'], trap: 'The Stonewall can become a prison if Black never creates a kingside plan or central break.', defense: 'White should pressure the dark squares and seek exchanges that expose Black’s weak light squares.' },
]
...
const pawnStructures = [
  ...
  { id: 'kings-indian-centre', title: "King's Indian centre", label: 'Locked tension', signal: 'White has space with d5/e4 while Black has a chain on d6/e5 and pieces aimed at the centre.', plan: 'White uses queenside space and piece pressure before Black’s kingside attack lands. Black must decide whether ...f5 creates a real break or only weakens the king.', breaks: 'White: c5 or b4–b5 · Black: ...f5 or ...c6', warning: 'The classic wing attacks depend on a locked centre. If the centre can open, development and king safety become urgent again.' },
  { id: 'hedgehog', title: 'Hedgehog', label: 'Elastic defence', signal: 'One side is compact behind pawns on a6, b6, d6, and e6 while the opponent has more space but fewer clear entry squares.', plan: 'The cramped side waits for the right freeing break; the space side improves pieces, controls the breaks, and avoids overextending.', breaks: 'Defender: ...b5 or ...d5 · Attacker: restrain, then open a file on favourable terms', warning: 'Space alone does not win. If the hedgehog breaks at the right moment, the apparently passive pieces become active at once.' },
  { id: 'stonewall', title: 'Stonewall', label: 'Dark-square map', signal: 'A fixed chain f5–e6–d5 gives one side e4 control but leaves the light squares and the bad bishop as long-term concerns.', plan: 'Use the e4 outpost and kingside pieces if you own the wall. Against it, trade the active dark-square pieces and attack the weak light squares.', breaks: 'With wall: ...c5 or ...e5 only when prepared · Against wall: c4/cxd5 and pressure on e6', warning: 'Do not lock the centre before the dark bishop has a role. A good outpost cannot compensate for every inactive piece.' },
]
